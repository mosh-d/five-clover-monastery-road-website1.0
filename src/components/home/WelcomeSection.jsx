    ...
    >
      ...
      <div className="flex max-sm:flex-col gap-[2rem]">
        <p className="font-secondary text-3xl mx-[1rem] font-bold">
          36 Town Planning Way, 102215 Lagos, Nigeria
        </p>
        <a
          data-component="Map link"
          href="https://maps.google.com/?q=36+Town+Planning+Way,+102215+Lagos,+Nigeria"
          target="_blank"
