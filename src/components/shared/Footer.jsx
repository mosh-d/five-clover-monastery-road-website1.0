  ...
  return (
    <>
      <div
        ...
        className="text-[color:var(--footer-text-color)] bg-[color:var(--accent-2)] px-24 md:px-12 lg:px-[12rem] max-sm:px-[4rem] py-12 md:py-[6rem] max-sm:py-[4rem] flex flex-col gap-[6rem] md:gap-[6rem] justify-center items-center"
      >
        <Logo />
        <div
